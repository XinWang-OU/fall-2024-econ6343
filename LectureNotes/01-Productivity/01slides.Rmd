...
2. Paid subscription to a generative AI service (e.g. OpenAI, Anthropic, Google, etc.)

3. Book (free [online](https://eml.berkeley.edu/books/choice2.html)):

  1. Train (2003)

4. Various published academic papers
...
- Write a research proposal for an idea for your dissertation research
...
- "No holds barred" regarding use of AI assistance
...
- The paper shouldn't be published, or if it has been published, you should use the earliest pre-print version available
...
- You are encouraged to use AI models in drafting this idea

---

# Slides

All slides will be available on the [course GitHub page](https://github.com/OU-PhD-Econometrics/fall-2024)
...
- Of course, any frontier AI model will be able to provide you with expert, individualized help
...
- I really like Julia because it is easy to code in and delivers excellent performance
...
- (Note: package installation in Julia can sometimes take quite awhile)
...
- There is a [separate slide deck](https://raw.githack.com/OU-PhD-Econometrics/fall-2024/master/LectureNotes/00-JuliaTips/00slides.html#1) for your reference
...
- Microsoft's VS Code seems to be gaining quite a bit of popularity (in part due to the AI assistance provided by GitHub Copilot)
...
- Just choose one you like and go with it. I use VS Code with Vim keybindings
...
- Or you can just post updates manually to the GitHub website
...
- .hi-crimson[Add (Stage):] Tell Git which changes you want to add to the repository's history
...
- .hi-crimson[Fetch:] Download a branch but don't merge it (pull $\equiv$ fetch and then merge)

- .hi-crimson[Pull request:] When you propose changes to a repository you don't own
    - i.e. you "request" that another user "pull" (i.e. fetch and merge) your branch of their repository, where you have made some changes to their repository
...
- [Here](https://www.youtube.com/watch?v=i_23KUAEtUM) is a video tutorial on using Git with VS Code
...
- After signing up for a GitHub account, go to the class [repository](https://github.com/OU-PhD-Econometrics/fall-2024) and click `Fork` in the top-righthand corner

- Once you do this, you should be able to visit https://github.com/your-username/fall-2024 and see an exact copy of all of the files

- You can also rename your fork if the default name of "fall-2024" is not to your liking
...
- I have been programming for well over 15 years and I still make bone-headed mistakes (just ask my co-authors!)
