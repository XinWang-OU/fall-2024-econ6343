...
- `r Citet(biblio,"roth_al2022")` provide an overview of recent advances

- `r Citet(biblio,"deChaiseDHault2022")` also provide an overview
...
- Multiple periods and variation in treatment timing:
    ...
    - `r Citet(biblio,"deChaiseDHault2020AER")`; `r Citet(biblio,"bacon2021")`; `r Citet(biblio,"cs2021")`; `r Citet(biblio,"sunAbraham2021")`

- Relaxing parallel trends assumption / testing for pre-trends:

    - `r Citet(biblio,"roth2022")`; others (see `r Citet(biblio,"roth_al2022")`)

- Appropriate standard errors in DiD estimation:

    - `r Citet(biblio, "rothSantAnna2022")`; others (see `r Citet(biblio,"roth_al2022")`)
...
- `r Citet(biblio,"angristFrandsen2022")`
